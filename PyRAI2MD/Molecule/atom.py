######################################################
#
# PyRAI2MD 2 module for creating atom objects
#
# Author Jingbai Li
# Apr 29 2021
#
...
class Atom:
    """ Periodic table class
        ...
        Parameters:
            name             str/int  atom name

        Return:
            fullname         str      element name
            symbol           str      chemical symbol
            uppersymbol      str      chemical symbol in uppercase
            mass             float    atom mass in g/mol
            nuc              int      atomic number
            nelectron        int      number of electron
            radii            float    Van der Waals radii in Angstrom
